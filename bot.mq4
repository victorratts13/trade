...
int start()
{
  ...
  {
     int result=0;
     if((iMA(NULL,PERIOD_M1,1,0,MODE_SMA,PRICE_CLOSE,1)>iMA(NULL,PERIOD_M1,21,1,MODE_SMA,PRICE_CLOSE,21))) // Here is your open buy rule
     {
     ...
     if((iMA(NULL,PERIOD_M1,21,1,MODE_SMA,PRICE_CLOSE,21)>iMA(NULL,0,1,0,MODE_SMA,PRICE_CLOSE,1))) // Here is your open Sell rule
     {
